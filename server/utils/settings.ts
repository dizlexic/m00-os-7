 ...
 * Save user settings.
 */
export function saveSettings(userId: number | string, settings: Record<string, any>, database?: Database): void {
 ...
 * Get user settings.
 */
export function getSettings(userId: number | string, database?: Database): Record<string, any> {
  const db = database || getDb();
